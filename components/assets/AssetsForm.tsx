      ...
      <form id="asset-form" data-testid="asset-form" onSubmit={handleSubmit} className="space-y-[var(--ft-form-section-gap)]">
        ...
        >
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="inline-flex min-w-0 cursor-not-allowed items-center gap-2 rounded-[var(--ft-form-radius)] border border-dashed border-[var(--ft-form-border)] bg-[var(--ft-surface-muted)] px-4 py-3 text-[12px] font-medium text-[var(--ft-form-muted)] opacity-60">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                <polyline points="17 8 12 3 7 8"/>
                <line x1="12" y1="3" x2="12" y2="15"/>
              </svg>
              <span className="min-w-0 truncate">Carga de archivo no disponible</span>
            </div>

            <p className="max-w-[62ch] text-[12px] leading-[1.45] text-[var(--ft-form-muted)]">
