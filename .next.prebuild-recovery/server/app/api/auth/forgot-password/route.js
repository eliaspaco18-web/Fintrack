"use strict";(()=>{var e={};e.id=9118,e.ids=[9118],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},40790:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>y,patchFetch:()=>R,requestAsyncStorage:()=>m,routeModule:()=>x,serverHooks:()=>b,staticGenerationAsyncStorage:()=>h});var a={};r.r(a),r.d(a,{POST:()=>f});var o=r(49303),n=r(88716),s=r(60670),i=r(91585),l=r(15717),p=r(6906),c=r(93304),d=r(49374);let u=i.Ry({email:i.Z_().trim().email("Ingresa un correo v\xe1lido").max(160)}),g=new Map;async function f(e){let t;try{t=await e.json()}catch{return(0,p.qF)({code:"VALIDATION_ERROR",message:"Body JSON inv\xe1lido"})}let r=u.safeParse(t);if(!r.success)return(0,p.QM)(r.error);let a=(0,d.iA)(e),o=`${a}/auth/callback?next=${encodeURIComponent("/settings?tab=security")}`,n=function(e){let t=e.headers.get("x-forwarded-for");if(t)return t.split(",")[0]?.trim()||"unknown";let r=e.headers.get("x-real-ip");return r?.trim()||"unknown"}(e);if(function(e){let t=Date.now(),r=g.get(e);return!r||t>r.resetAt?(g.set(e,{count:1,resetAt:t+6e5}),!1):r.count>=5||(g.set(e,{count:r.count+1,resetAt:r.resetAt}),!1)}(`${n}:${r.data.email.toLowerCase()}`))return(0,p.N9)({message:"Si el correo existe, recibir\xe1s un enlace de recuperaci\xf3n en unos minutos."});let s=await (0,c.i)({email:r.data.email,appUrl:a,redirectTo:o});s.sent||console.warn("[forgot-password] custom email fallback:",s.reason);let i=(0,l.eI)();if(!s.sent){let{error:e}=await i.auth.resetPasswordForEmail(r.data.email,{redirectTo:o})}return(0,p.N9)({message:"Si el correo existe, recibir\xe1s un enlace de recuperaci\xf3n en unos minutos."})}let x=new o.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/auth/forgot-password/route",pathname:"/api/auth/forgot-password",filename:"route",bundlePath:"app/api/auth/forgot-password/route"},resolvedPagePath:"/Users/eliasgustavopacopauccara/Documents/Fintrack_v1/fintrack/app/api/auth/forgot-password/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:m,staticGenerationAsyncStorage:h,serverHooks:b}=x,y="/api/auth/forgot-password/route";function R(){return(0,s.patchFetch)({serverHooks:b,staticGenerationAsyncStorage:h})}},6906:(e,t,r)=>{r.d(t,{Gu:()=>n,N9:()=>o,QM:()=>p,Yv:()=>c,bN:()=>u,l:()=>d,qF:()=>l,y3:()=>s});var a=r(87070);function o(e,t=200){return a.NextResponse.json({ok:!0,data:e},{status:t})}function n(e){return a.NextResponse.json({ok:!0,data:e},{status:201})}function s(){return new a.NextResponse(null,{status:204})}let i={NOT_FOUND:404,UNAUTHORIZED:401,VALIDATION_ERROR:422,BUSINESS_RULE_ERROR:422,DATABASE_ERROR:500,ATOMICITY_FAILURE:500};function l(e){let t=i[e.code]??500;return a.NextResponse.json({ok:!1,error:{code:e.code,message:e.message,detail:e.detail}},{status:t})}function p(e){let t={};for(let r of e.issues){let e=r.path.join(".");t[e]||(t[e]=[]),t[e].push(r.message)}let r=e.issues[0],o=r?.path.join(".")||"dato",n=r?.message?`Campo "${o}": ${r.message}`:void 0;return a.NextResponse.json({ok:!1,error:{code:"VALIDATION_ERROR",message:"Los datos enviados no son v\xe1lidos",detail:n,fields:t}},{status:422})}function c(e="No autorizado"){return a.NextResponse.json({ok:!1,error:{code:"UNAUTHORIZED",message:e}},{status:401})}function d(e,t){return e.ok?o(e.data,t??200):l(e.error)}async function u(e){let{data:{user:t}}=await e.auth.getUser();return t?.id??null}},22576:(e,t,r)=>{r.d(t,{m:()=>n,v:()=>s});var a=r(82591);let o=process.env.RESEND_API_KEY,n=o?new a.R(o):null,s=process.env.RESEND_FROM_EMAIL??"FinTrack <noreply@fintrack.app>"},93304:(e,t,r)=>{r.d(t,{i:()=>s});var a=r(22576),o=r(15717);function n(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function s(e){if(!a.m)return{sent:!1,reason:"RESEND_NOT_CONFIGURED"};if(!process.env.SUPABASE_SERVICE_ROLE_KEY)return{sent:!1,reason:"SERVICE_ROLE_NOT_CONFIGURED"};try{let t=(0,o.mq)(),{data:r,error:s}=await t.auth.admin.generateLink({type:"recovery",email:e.email,options:{redirectTo:e.redirectTo}}),i=r?.properties?.action_link;if(s||!i)return console.error("[password-reset-email] generate link error:",s),{sent:!1,reason:"GENERATE_LINK_FAILED"};let{error:l}=await a.m.emails.send({from:a.v,to:e.email,subject:"Restablece tu contrasena de FinTrack",html:function(e){let t=n(e.resetUrl),r=n(`${e.appUrl.replace(/\/+$/,"")}/brand/fintrack-mark.png`),a=Number.isFinite(e.expiresInMinutes)?Math.max(1,Math.floor(e.expiresInMinutes)):60;return`<!DOCTYPE html>
