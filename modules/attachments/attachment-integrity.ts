...
export const ATTACHMENT_UPLOAD_UNAVAILABLE_MESSAGE =
  'La carga de adjuntos no está disponible de forma segura en este módulo. Guarda el registro sin archivo.'

export const ATTACHMENT_REFERENCE_UNVERIFIED_MESSAGE =
  'Existe una referencia guardada, pero su disponibilidad no puede verificarse desde esta pantalla.'
...
export function hasUnsupportedAttachmentWrite(body: unknown): boolean {
  if (!body || typeof body !== 'object') return false
  if (!Object.prototype.hasOwnProperty.call(body, 'attachment_url')) return false

  return (body as { attachment_url?: unknown }).attachment_url !== undefined
}
